    ...
    <div className="bg-white dark:bg-stone-800 rounded-lg shadow-sm border border-stone-200 dark:border-stone-700 p-6">
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-1">
          <span className="text-sm font-medium text-stone-700 dark:text-stone-300">Risk Score</span>
      ...
      {frat.factors.length > 0 ? (
                ...
                <div key={category}>
                  ...
                  <div className="space-y-2">
                    {factors.map((factor, index) => (
                      <div
                        key={index}
                        className="flex items-start justify-between p-2 bg-stone-50 dark:bg-stone-700 rounded"
                      >
                        ...
                        <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-bold bg-stone-200 dark:bg-stone-600 text-stone-700 dark:text-stone-300 whitespace-nowrap">
                          +{factor.points}
                        </span>
                      </div>
                    ))}
        ...
        <p className="text-sm text-stone-500">No risk factors identified.</p>
      )}
    </div>
  );
}
